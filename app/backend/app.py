...
def chat():
    ...
    try:
        ...
        input_audio_path = request.json["input_audio_path"]
        ...
        if input_audio_path.lower().endswith(".wav"):
            ...
            translated_english_text, detected_language = blob_to_speech_to_text_text(input_audio_path)
            # recognize_text = speech_recognize_once_with_auto_lang uage_detection_from_file(blob=input_audio_path)
